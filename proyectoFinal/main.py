...
num_of_ants = 15    #antes 5
num_of_cities = 10
positions = np.array(range(num_of_ants))
graph = Graphicator()
graph.city_creator(np.array([[5.40430988, 0.73653076],
                                [6.59176078, 2.64506678],
                                [2.23231415, 7.14374267],
                                [8.6475832 , 6.84029531],
                                [0.99234353, 3.77177196],
                                [4.57445423, 0.44335893],
                                [5.48794392, 8.92536451],
                                [4.57664581, 1.36571595],
                                [3.71361591, 5.75636711],
                                [2.70066305, 3.77415016]]))
...
def plot():
    ...
    if r:
        ...
        graph.plot_distances(best_ant_dist, 0)
