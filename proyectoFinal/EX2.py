...
epsilon = 1e-5
phi = 0.5
num_of_ants_x_colony = 1 #antes 5
num_of_cities = 4
positionsA = np.random.randint(0, 2, size=num_of_ants_x_colony)
positionsB = np.random.randint(2, 4, size=num_of_ants_x_colony)
graph = Graphicator()
...
map.change_objectiveA(objectiveA)
map.change_objectiveB(objectiveB)
